    ...
    <Transition appear show={modal.visible} as={Fragment}>
      <Dialog as='div' className='relative z-10' onClose={closeModal}>
        <Transition.Child
          ...
          leaveTo='opacity-0'>
          <div className='fixed inset-0 bg-black/25 dark:bg-black/75' />
        </Transition.Child>
        ...
        <div className='fixed inset-0 overflow-y-auto'>
          <div className='flex items-center justify-center min-h-full p-4 text-center'>
            <Transition.Child
              ...
              <Dialog.Panel className='w-full max-w-md p-6 overflow-hidden text-left text-gray-900 align-middle transition-all transform bg-white shadow-xl dark:text-white dark:bg-slate-800 rounded-2xl'>
